...
public class Questao08 {
	...
	public static int KEsimoMaiorValor(int[] vetorInteiro, int k) {
		...
		if (k <= vetorOrdenado.length) {
			...
			System.out.println("não há um K-ésimo maior valor");
			return 0;
	...
	public static void main(String[] args) {
		...
		System.out.println("K-ésimo maior valor: " + KEsimoMaiorValor);
